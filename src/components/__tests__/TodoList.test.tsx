...
describe('TodoList Component', () => {
  ...
  it('toggles todo completion status', async () => {
    ...
    expect(call[0].some((todo: TodoItem) => todo.id === '1' && todo.completed === true)).toBe(true);
  });
  ...
  it('edits a todo', async () => {
    ...
    const editInput = allInputs.find(input => 
      (input as HTMLInputElement).value === 'Test Todo 1'
    );
